...
async function responderComIA(pergunta) {
  const resposta = await axios.post(
    ...
    {
      headers: {
        "Authorization": "Bearer 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",
        "Content-Type": "application/json",
      },
    }
  );
